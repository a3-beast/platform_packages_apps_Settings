...
public class OpSettingsCustomizationUtils {
    ...
    static {
        ...
        sOperatorFactoryInfoList.add(
                new OperatorFactoryInfo("OP03Settings.apk",
                         "com.mediatek.op03.settings.OP03SettingsCustomizationFactory",
       ...
       sOperatorFactoryInfoList.add(
                new OperatorFactoryInfo("OP16Settings.apk",
                         "com.mediatek.op16.settings.Op16SettingsCustomizationFactory",
                         "com.mediatek.op16.settings",
                         "OP16",
                         "SEGDEFAULT"
                        ));
        sOperatorFactoryInfoList.add(
