...
public class HdmiSettings extends SettingsPreferenceFragment implements
    ...
    private static final String HDMI_VIDEO_RESOLUTION = "persist.vendor.sys.hdmi.resolution";
    private static final String HDMI_ENABLE = "persist.vendor.sys.hdmi.enable";
    private static final String HDMI_VIDEO_AUTO = "persist.vendor.sys.hdmi.auto";
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (KEY_TOGGLE_HDMI.equals(key)) {
            ...
            HdimReflectionHelper.enableHdmi(mHdmiManager, checked);
