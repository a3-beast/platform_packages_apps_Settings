...
public class SimSelectNotification extends BroadcastReceiver {
    ...
    private static final String ACTION_SUBINFO_RECORD_UPDATED =
            "com.mediatek.settings.sim.ACTION_SUBINFO_RECORD_UPDATED";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_SUBINFO_RECORD_UPDATED.equals(action)) {
            /// M: Ignore this broadcast when the detected type is NOCHANGE. @{
            final int detectedType = intent.getIntExtra(
                    MtkSubscriptionManager.INTENT_KEY_DETECT_STATUS, 0);
            Log.d(TAG, "sub info update, type=" + detectedType + ", subs=" + sil);
            ...
            numSims = intent.getIntExtra(
                    MtkSubscriptionManager.INTENT_KEY_SIM_COUNT, numSims);
            if (sil != null && numSims != sil.size()) {
